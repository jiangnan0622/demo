export const realMobileBasePath = "/real-mobile-v1";
...
export const realMobileProducts: RealMobileProduct[] = [
  {
    ...
    name: "兴尉城投",
    publisher: "兴尉城市建设投资",
    publisherEn: "Xingwei Urban Construction Investment",
    tags: ["质押生息", "每日奖励"],
    price: "1.00",
    priceUnit: "1.00 USDC",
    apr: "10.05",
    ...
    soldLabel: "0M",
    totalLabel: "3.80M",
    issueDate: "Mon 04, Mar 2024",
    expireDate: "Mon 04, Mar 2027",
    minimum: "10.00 USDC",
    marketCap: "$4.68M",
    volume24h: "$128.60K",
    cycle: "3 Years",
    ...
    logoUrl: "https://cdn.jsdelivr.net/gh/jiangnan0622/token-assets@main/rXWCT.png",
    status: "selling",
    description:
  ...
  },
  {
    ...
    name: "商都城投",
    publisher: "商都城市建设投资",
    publisherEn: "Shangdu Urban Investments Group",
    tags: ["质押生息", "每日奖励"],
    price: "1.00",
    priceUnit: "1.00 USDC",
    apr: "10.05",
  ...
  },
  {
    ...
    name: "复星财富控股",
    publisher: "BNY货币基金",
    publisherEn: "BNY Money Market Fund",
    tags: ["头部交易所认可抵押物"],
    price: "1.00",
    priceUnit: "1.00 USDC",
    apr: "10.05",
...
export const portfolioAssets = [
  ...
  { token: "srXWCT", balance: "8,000.00", value: "8,000.00 R Token", apr: "10.05%", reward: "86.44 REAL" },
